    ...
    <nav class="sidebar close">
        ...
        <div class="menu-bar">
            <div class="menu">
                <ul class="menu-links">
                    <li>
                        <a href="" class="side-link active" title="Home">
                            <i class='bx bxs-home icon'></i>
                            <span class="text nav-text">Home</span>
                        </a>
                    </li>
                    <li>
                        <a href="jadwal-tayang.html" class="side-link" title="Jadwal Tayang">
                            <i class='bx bxs-calendar icon'></i>
                            <span class="text nav-text">Jadwal Tayang</span>
                        </a>
                    </li>
                    <li>
                        <a href="katalog-anime.html" class="side-link" title="Katalog Anime">
                            <i class='bx bx-list-ul icon'></i>
                            <span class="text nav-text">Katalog Anime</span>
                        </a>
                    </li>
                    <li>
                        <a href="riwayat-menonton.html" class="side-link" title="Riwayat Menonton">
                            <i class='bx bx-history icon'></i>
                            <span class="text nav-text">Riwayat Menonton</span>
                        </a>
                    </li>
                    <li>
                        <a href="subscribed-anime.html" class="side-link" title="Subscribed Anime">
                    ...
                    <ul class="navbar-nav mx-0 me-4 ms-auto my-1" id="dropdown">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-light" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <img class="img" src="https://ui-avatars.com/api/?name={{ Auth::user()->name }}" width="26px" style="border-radius: 50%;">
                ...
                <div class="row d-flex">
                    <div class="col d-flex gap-3 w-100">
                        <div class="profile-image">
                            <img class="img" src="https://ui-avatars.com/api/?name={{ Auth::user()->name }}" width="50px" style="border-radius: 50%;">
                        </div>
